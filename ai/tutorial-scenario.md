...
- Save version 7 persists the first-night fauna stage rather than individual runtime animals. Loading an unresolved `MiceVisible` state reconstructs the mice and replays the rat prelude plus chronicle; legacy saves already at or beyond the first Night migrate as completed and do not replay the presentation.
