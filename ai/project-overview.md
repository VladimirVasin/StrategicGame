...
- Runtime weather randomizes Clear, Cloudy, LightRain, HeavyRain, Fog, Storm, Snow, and Blizzard states, drives cloud-shadow/rain/snow/heavy-precipitation-mist/wet-ground/cold-ground-wash overlays plus gradual seasonal ground snow, water ice, and building snow caps, feeds dense Fog weather into fog-of-war visibility, boosts wind, intensifies water ripples only from rain/storms, feeds rain/wind ambience, and exposes an informational outdoor temperature derived from season, time of day, daily variation, and weather.
