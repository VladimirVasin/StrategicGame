...
- Storage Yard is implemented as the first storage/logistics building: it has procedural 2.5D art, uncapped assigned Haulers/builders, uncapped local Logs, Stone, Iron, Coal, and Planks stock, growing visual stockpiles, resident hauling from production camps/Mines/Coal Pits/Sawmills, food hauling to Granaries, production-input delivery to production nodes, and construction resource reservations.
