...
- Smart auto workforce assignment can be toggled from the Profession HUD; it uses player priorities for Construction, Food, Logistics, Wood, Stone, Planks, Iron, and Coal to rebalance overstaffed professions and assign eligible free adults through existing worksite APIs based on shortages, storage backlog, construction readiness, and distance.
