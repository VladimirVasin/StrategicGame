...
- Current Build catalog has Houses/Home, Industries/Lumberjack Camp, Stonecutter Camp, Sawmill, Kiln, Hunter Camp, Fisher Hut, Mine, Coal Pit, and Clay Pit, Storage/Storage Yard and Granary, and Infrastructure/Bridge.
...
- Smart auto workforce assignment can be toggled from the Profession HUD; it treats player values for Construction, Food, Logistics, Wood, Stone, Planks, Iron, Coal, Clay, and Pottery as desired worker targets, rebalances overstaffed professions, and assigns eligible free adults through existing worksite APIs while using shortages/backlog/readiness/distance to score urgency.
