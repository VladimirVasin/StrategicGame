...
- A startup camp places an animated procedural campfire and 6 initial residents: 3 men and 3 women.
...
- Building a house construction site now reserves one random free man and one random free woman from the camp as future residents instead of creating new residents.
- Residents have runtime full names, 5 runtime-generated male variants, 5 runtime-generated female variants, matching portrait sprites, and idle movement around their current camp/home through nearby walkable cells.
...
- Selected houses can install visual-only Garden Beds and Chicken Coop upgrades from the right-side HUD.
