...
- A runtime trail layer records weighted resident foot traffic for functional movement/path-cost preference, records completed building-to-building route traversals for visible trail formation, decays unused old trails back out of view, renders connected procedural right-angle cardinal trail sprites, gives formed trails a 15% resident movement-speed bonus, and makes resident pathfinding prefer trails when practical.
