...
- A runtime nature-props layer places procedural 2.5D trees, forest groups, bushes, Stone deposits, walkable but not normally buildable mineable underground Iron/Coal fields, and near-water walkable Clay fields over the generated terrain.
...
- Current Build catalog has Housing/House, Extraction/Lumberjack Camp, Stonecutter Camp, Mine, Coal Pit, Clay Pit, Hunter Camp, and Fisher Hut, Production/Sawmill, Kiln, and Forge, Storage/Storage Yard and Granary, and Infrastructure/Bridge.
