...
namespace ProjectUnknown.Strategy
{
    ...
    public sealed partial class StrategyBuildMenuController : MonoBehaviour
    {
        ...
        private void CreateBuildButton(Transform parent)
        {
            ...
            DrawBuildIcon(icon, new Color(0.95f, 0.72f, 0.28f), new Color(0.35f, 0.42f, 0.46f));
        ...
        private sealed class BuildCategoryData
        {
        ...
        private sealed class BuildItemData
        {
