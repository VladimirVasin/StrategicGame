    ...
    public sealed class StrategyPerformanceDiagnostics : MonoBehaviour
    {
        ...
        private void LogWindow(string reason)
        {
            ...
            StrategyDebugLogger.Info(
                ...
                StrategyDebugLogger.F("audioVoices", StrategyAudioVoicePool.ActiveVoiceCount),
                StrategyDebugLogger.F("audioVoiceCapacity", StrategyAudioVoicePool.Capacity),
                StrategyDebugLogger.F("audioVoiceDrops", StrategyAudioVoicePool.DroppedVoiceCount),
